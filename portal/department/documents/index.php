            ...
            <table class="table text-nowrap mb-0 align-middle" id="dataTable">
                <thead class="text-dark fs-4">
                    <tr>
                        ...
                        <th class="border-bottom-0">
                            <h6 class="fw-semibold mb-0">Document Title</h6>
                        </th>
                        <th class="border-bottom-0">
                ...
                <tbody>
                    <?php
                    $count = 0;
                    foreach ($Document->DepartmentDocument($code) as $row) : $count++;
                    ...
                    <tr>
                        ...
                        <td class="border-bottom-0">
                            <div class="d-flex align-items-center gap-2">
                                <span
                                    class="badge <?= $bg_color ?> rounded-3 fw-semibold"><?php echo $row['status'] ?></span>
                            </div>
                        </td>
                        <td class="border-bottom-0">
                        ...
                        <td class="border-bottom-0">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li><a onclick="return confirm('Are you sure?')" class="dropdown-item"
                                            href="?done&reference=<?= $row['reference'] ?>">Done</a></li>
                                    <li><a class="dropdown-item"
                                            href="edit.php?reference=<?= $row['reference'] ?>">Edit</a></li>
                                    <li><a class="dropdown-item"
                                            href="details.php?reference=<?= $row['reference'] ?>">Print QR</a></li>
                                    <li><a class="dropdown-item"
                                            href="track.php?reference=<?= $row['reference'] ?>">Track</a></li>
                                    <li><a onclick=" return confirm('Are you sure?')" class="dropdown-item"
                                            href="index.php?delete&reference=<?= $row['reference'] ?>">Delete</a></li>
                                    <?php  } else {
